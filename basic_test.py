...
class Testing(unittest.TestCase):
    def test_game1(self):
        ...
        self.assertTrue(t16 == 'Transition infeasible: controls=True area_has_item=True area_accessible=False can_eat=True can_hide=True')
        self.assertTrue(t18 == 'Transition infeasible: controls=True area_has_item=False area_accessible=True can_eat=True can_hide=True')
        self.assertTrue(t20 == 'Transition infeasible: controls=True area_has_item=True area_accessible=True can_eat=False can_hide=True')
        self.assertTrue(t28 == 'Transition infeasible: is_subarea_or_animal=True; can_decrement=False')
        self.assertTrue(t29 == 'Transition infeasible: is_subarea_or_animal=True; can_decrement=False')
        self.assertTrue(t34 == 'Transition infeasible: is_subarea_or_animal=True; can_increment=False')
        self.assertTrue(t35 == 'Transition infeasible: is_subarea_or_animal=False; can_increment=False')
        self.assertTrue(t39 == 'Transition infeasible: is_subarea_or_animal=True; can_decrement=False')
